...
object CommandError {
  ...
  case class InvalidSettingsPath(path: String) extends CommandError(s"Invalid path: $path")
  ...
  case class MissingSettingsPath(path: String) extends CommandError(s"Path does not exist: $path")
